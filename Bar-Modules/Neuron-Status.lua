...
function NeuronStatusBar:OnInitialize()
    ...
    Neuron:RegisterBarClass("status", "StatusBarGroup", L["Status Bar"], "Status Bar", DB.statusbar, NeuronStatusBar,"Button", "NeuronStatusBarTemplate", { __index = Neuron.STATUSBTN }, 1000)
